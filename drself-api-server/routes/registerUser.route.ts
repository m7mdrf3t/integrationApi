...
import dotenv from 'dotenv'; // If you're using dotenv for local environment variables
...
router.post('/register', async (req, res) => {
  ...
  try {
    ...
    const edgeFunctionResponse = await fetch(`${supabaseUrl}/functions/v1/register-user`, {
      method: 'POST',
      headers: {
